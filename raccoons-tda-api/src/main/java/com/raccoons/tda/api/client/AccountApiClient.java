...
import com.raccoons.tda.api.response.*;
...
public class AccountApiClient extends BaseApiClient {
    ...
    public AccountApiClient(TDAContext tdaContext) {
        super(tdaContext);
    }
    ...
    public CompletableFuture<OrderResponse> cancelOrder(final AccountContext accountContext, final String orderId) {
        ...
        return tdaHttpClient.deleteAsync(endpoint, accountContext.getAuthorizationHeader()).thenApply(tdaHttpResponse -> {
    ...
    public CompletableFuture<OrderPositionResponse> getOrder(final AccountContext accountContext, final String orderId) {
        ...
        return tdaHttpClient.getAsync(endpoint, accountContext.getAuthorizationHeader()).thenApply(tdaHttpResponse -> {
    ...
    public CompletableFuture<OrderPositionResponse> getOrdersByPath(final AccountContext accountContext,
        ...
        return tdaHttpClient.getAsync(endpoint, accountContext.getAuthorizationHeader(), parameters)
    ...
    public CompletableFuture<OrderPositionResponse> getOrdersByQuery(final AccountContext accountContext,
        ...
        if (accountId != null) {
            ...
            return tdaHttpClient.getAsync(endpoint, accountContext.getAuthorizationHeader(), parameters).thenApply(tdaHttpResponse -> {
                System.out.println();
                return null;
            });
        }
    ...
    public CompletableFuture<AccountResponse> getAccountAsync(final AccountContext accountContext) {
        final String accountId = accountContext.getAccountId();
    ...
    public CompletableFuture<AccountResponse> getAccountsAsync(final AccountContext accountContext) {
    ...
    public TDAResponse<Account> getAccount(final AccountContext accountContext){
        return null;
    }

    public TDAResponse<Accounts> getAccounts(final AccountContext accountContext){
        return null;
    }
