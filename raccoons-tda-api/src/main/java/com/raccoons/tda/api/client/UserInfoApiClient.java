...
public class UserInfoApiClient extends BaseApiClient {
    ...
    public UserInfoApiClient(TDAContext tdaContext) {
        super(tdaContext);
    }
    ...
    public CompletableFuture<TDAResponse> getPreferences(final AccountContext accountContext) {
        ...
        return tdaHttpClient.getAsync(endpoint, accountContext.getAuthorizationHeader()).thenApply(new Function<TDAHttpResponse, TDAResponse>() {
            @Override
    ...
    public CompletableFuture<UserPrincipleResponse> getUserPrincipals(final AccountContext accountContext, final String... fields) {
        ...
        return tdaHttpClient.getAsync(endpoint, accountContext.getAuthorizationHeader(), parameters).thenApply(UserInfoResponses::getUserPrincipleResponse);
    }
