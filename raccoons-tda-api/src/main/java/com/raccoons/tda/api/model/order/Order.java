...
public class Order extends ApiModel {
    ...
    private List<Execution> orderActivityCollection;

    @JsonProperty("replacingOrderCollection")
    private List<Order> replacingOrderCollection;

    @JsonProperty("childOrderStrategies")
    private List<Order> childOrderStrategies;
    ...
    public List<Execution> getOrderActivityCollection() {
